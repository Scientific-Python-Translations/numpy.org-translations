...
{{< blockquote
  ...
  by="Alexander Mathis, _Profesor Asistente, Escuela Politécnica Federal de Lausana_ ([EPFL](https://www.epfl.ch/en/))"
>}}
Open Source Software is accelerating Biomedicine. DeepLabCut permite el análisis automatizado de video del comportamiento animal utilizando Aprendizaje Profundo.{{< /blockquote >}}
