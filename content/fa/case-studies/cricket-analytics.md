---
title: "مطالعه موردی: تحلیل کریکت، دگرگون‌کننده بازی!"
sidebar: false
---
...
این که بگوییم هندی‌ها کریکت را دوست دارند، کم‌گویی است. این بازی در تقریباً هر گوشه و کنار هند، چه روستایی و چه شهری، انجام می‌شود و در میان جوانان و سالمندان به یک اندازه محبوب است و میلیاردها نفر را در هند به شکلی بی‌نظیر به هم پیوند می‌دهد.
کریکت از توجه گسترده رسانه‌ها برخوردار است. There is a significant amount of
[money](https://www.statista.com/topics/4543/indian-premier-league-ipl/) and
fame at stake. طی چند سال گذشته، فناوری به معنای واقعی کلمه جریان بازی را تغییر داده است. تماشاگران با گزینه‌های متعددی مانند رسانه‌های پخش زنده، مسابقات، دسترسی ارزان به تماشای کریکت زنده از طریق موبایل و موارد دیگر، مواجه هستند.

لیگ برتر هند (IPL) یک لیگ حرفه‌ای کریکت بیست‌بیست (Twenty20) است که در سال ۲۰۰۸ بنیان‌گذاری شد. It is one of the most attended cricketing events in
the world, valued at [$6.7 billion](https://en.wikipedia.org/wiki/Indian_Premier_League)
in 2019.

کریکت یک بازی بر پایه اعداد است - تعداد دویدن‌های یک ضربه‌زن (بتسمن)، تعداد ویکت‌های گرفته‌شده توسط یک پرتاب‌گر (بولر)، تعداد مسابقات برده شده توسط یک تیم کریکت، تعداد دفعاتی که یک ضربه‌زن به یک نوع حمله بولینگ به شکلی خاص پاسخ می‌دهد و غیره. The capability to
